...
#define ONE_SHOT_MODE1 __CONCAT(CLK_STRETCH_EN_MSB, CLK_STRETCH_EN_HIGH_REPEAT_LSB)
#define ONE_SHOT_MODE2 __CONCAT(CLK_STRETCH_EN_MSB, CLK_STRETCH_EN_MID_REPEAT_LSB)
#define ONE_SHOT_MODE3 __CONCAT(CLK_STRETCH_EN_MSB, CLK_STRETCH_EN_LOW_REPEAT_LSB)
#define ONE_SHOT_MODE4 __CONCAT(CLK_STRETCH_DIS_MSB, CLK_STRETCH_DIS_HIGH_REPEAT_LSB)
#define ONE_SHOT_MODE5 __CONCAT(CLK_STRETCH_DIS_MSB, CLK_STRETCH_DIS_MID_REPEAT_LSB)
#define ONE_SHOT_MODE6 __CONCAT(CLK_STRETCH_DIS_MSB, CLK_STRETCH_DIS_LOW_REPEAT_LSB)
...
#define PERIODIC_MODE1 = __CONCAT(MPS_0_5_MSB, MPS_0_5_HIGH_REPEAT_LSB)
#define PERIODIC_MODE2 = __CONCAT(MPS_0_5_MSB, MPS_0_5_MID_REPEAT_LSB)
#define PERIODIC_MODE3 = __CONCAT(MPS_0_5_MSB, MPS_0_5_LOW_REPEAT_LSB)
#define PERIODIC_MODE4 = __CONCAT(MPS_1_MSB, MPS_1_HIGH_REPEAT_LSB)
#define PERIODIC_MODE5 = __CONCAT(MPS_1_MSB, MPS_1_MID_REPEAT_LSB)
#define PERIODIC_MODE6 = __CONCAT(MPS_1_MSB, MPS_1_LOW_REPEAT_LSB)
#define PERIODIC_MODE7 = __CONCAT(MPS_2_MSB, MPS_2_HIGH_REPEAT_LSB)
#define PERIODIC_MODE8 = __CONCAT(MPS_2_MSB, MPS_2_MID_REPEAT_LSB)
#define PERIODIC_MODE9 = __CONCAT(MPS_2_MSB, MPS_2_LOW_REPEAT_LSB)
#define PERIODIC_MODE10 = __CONCAT(MPS_4_MSB, MPS_4_HIGH_REPEAT_LSB)
#define PERIODIC_MODE11 = __CONCAT(MPS_4_MSB, MPS_4_MID_REPEAT_LSB)
#define PERIODIC_MODE12 = __CONCAT(MPS_4_MSB, MPS_4_LOW_REPEAT_LSB)
#define PERIODIC_MODE13 = __CONCAT(MPS_10_MSB, MPS_10_HIGH_REPEAT_LSB)
#define PERIODIC_MODE14 = __CONCAT(MPS_10_MSB, MPS_10_MID_REPEAT_LSB)
#define PERIODIC_MODE15 = __CONCAT(MPS_10_MSB, MPS_10_LOW_REPEAT_LSB)
